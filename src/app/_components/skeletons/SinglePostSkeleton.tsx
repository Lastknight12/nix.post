...
export default function SinglePostSkeleton() {
  return (
    <div className="mt-2 max-w-[1080px] text-black">
      <div className="mb-6">
        <Skeleton className="h-7 w-[calc(100%-50vw)] rounded-md light before:border-transparent before:from-transparent before:to-transparent after:content-none light:bg-[#0000000a] light:before:via-[#ececec85] dark:bg-[#ffffff0d] dark:before:via-[#3333333d]" />
      </div>
